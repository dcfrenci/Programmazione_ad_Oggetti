...
class PhoneBookTest {
    ...
    PhoneBook pbook = new PhoneBook(people);
    @Test
    void searchByLastname() {
        assertEquals(Optional.empty(), pbook.searchByLastname("bianchi"));
        assertEquals(Optional.of(people.get(1)), pbook.searchByLastname("neri"));
    }

    @Test
    void searchByNameAndLastname() {
        assertEquals(Optional.empty(), pbook.searchByNameAndLastname("marzia","bianchi"));
        assertEquals(Optional.of(people.get(1)), pbook.searchByNameAndLastname("marzia", "neri"));
    }
}